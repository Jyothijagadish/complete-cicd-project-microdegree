    ...
    stages {
        ...
        stage('sonarqube-stage'){
            steps{
                ...
                -Dsonar.host.url=http://3.110.82.189:9000 \
                -Dsonar.login=faa66f85dcf5a7a4574a4e257e17c5e44d470b9a 
                """
            }
        }
        ...
        stage('Deploy To Kubernetes') {
            steps {
                withKubeConfig(caCertificate: '', clusterName: 'microdegree-cluster', contextName: '', credentialsId: 'kube', namespace: 'microdegree', restrictKubeConfigAccess: false, serverUrl: 'https://2C76A95FBC6F567F48B5D1D46DCA73F7.yl4.ap-south-1.eks.amazonaws.com') {
        ...
        always {
            script {
                ...
                emailext (
                    ...
                    from: 'akashjyothi369@gmail.com',
                    replyTo: 'akashjyothi369@gmail.com',
                    mimeType: 'text/html',
